...
type FormSelectProposalProps<TFormValues extends FieldValues = FieldValues> = {
...
const FormSelectProposal = <TFormValues extends Record<string, unknown>>({
  control,
  name,
  label,
  errors,
}: FormSelectProposalProps<TFormValues>): JSX.Element => {
  const {
    data: proposals,
        ...
        <FormItem className="flex-1">
          ...
          <FormControl>
            ...
            <Popover open={open} onOpenChange={setOpen}>
              ...
              <PopoverContent id="proposal-popover" className="w-full p-0">
                <Command>
                  <CommandInput
                    ...
                    {proposals?.proposals?.map((proposal) => (
                      <CommandItem
                        ...
                        onSelect={(currentValue) => {
                          ...
                          setOpen(false);
                          field.onChange(
                            currentValue === value ? undefined : proposal.title
                          );
                        }}
...
export default React.memo(FormSelectProposal);
