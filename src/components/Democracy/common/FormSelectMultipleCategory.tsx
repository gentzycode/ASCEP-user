...
type FormSelectMultipleCategoryProps<
...
const FormSelectMultipleCategory = <
...
>({
  ...
  selected,
  setSelected,
}: FormSelectMultipleCategoryProps<TFormValues>): JSX.Element => {
...
export default FormSelectMultipleCategory;
