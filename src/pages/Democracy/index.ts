...
export { default as ResolveDebateSharedIdPage } from "./debates/resolve-shared-id";
...
export { default as ResolveProposalSharedIdPage } from "./proposals/resolve-shared-id";
...
export { default as ResolveInitiativeSharedIdPage } from "./initiatives/resolve-shared-id";
...
export { default as ResolvePollSharedIdPage } from "./voting/resolve-shared-id";
// BUDGETING
